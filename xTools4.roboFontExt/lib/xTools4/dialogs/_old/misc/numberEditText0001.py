...
class RFNumberTextField_0001(NSTextField): # metaclass=ClassNameIncrementer
...
class BaseNumberEditText_0001(vanilla.EditText):

    nsTextFieldClass = RFNumberTextField_0001

    def __init__(self, *args, **kwargs):
        self._enterCallback = kwargs.get("enterCallback")
        if self._enterCallback:
            del kwargs["enterCallback"]
        super(BaseNumberEditText_0001, self).__init__(*args, **kwargs)
...
class NumberEditText_0001(BaseNumberEditText_0001):
    ...
    def __init__(self, posSize, text="", sizeStyle="regular", callback=None, allowFloat=True, allowNegative=True, allowEmpty=True, minimum=None, maximum=None, decimals=2, formatter=None, continuous=True):
        super(NumberEditText_0001, self).__init__(posSize, text="", callback=self._entryCallback, sizeStyle=sizeStyle, continuous=continuous)
    ...
    def set(self, value):
        ...
        if value is not None:
            ...
            if self._minimum is not None:
                ...
                value = 0
            value = self._numberToString(value)
        super(NumberEditText_0001, self).set(value)
...
if __name__ == '__main__':
    ...
    w.edit = NumberEditText_0001((10, 10, -10, 22), text='100.0', callback=callback, continuous=False)
    w.open()
