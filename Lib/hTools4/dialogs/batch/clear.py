...
from hTools3.modules.fontutils import clearMarkColors, clearUnicodes
...
class BatchClearDialog(BatchDialogBase):
    ...
    ::
        ...
        from hTools3.dialogs.batch.actions import BatchClearDialog
        BatchClearDialog()

    '''

    title = 'batch clear'
    key = '%s.clear' % BatchDialogBase.key
